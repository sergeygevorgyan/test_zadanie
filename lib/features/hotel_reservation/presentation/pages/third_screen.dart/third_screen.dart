...
import 'package:test_zadanie/features/hotel_reservation/presentation/pages/third_screen.dart/widgets/info_tile.dart';
import 'package:test_zadanie/features/hotel_reservation/presentation/pages/third_screen.dart/widgets/person_info_tile.dart';
...
import 'package:test_zadanie/features/hotel_reservation/presentation/widgets/masked_text_field.dart';
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                InfoTile(valueKey: 'Страна,город', value: data.arrival_country),
                const SizedBox(height: 16),
                InfoTile(
                    valueKey: 'Даты',
                    value: '${data.tour_date_start} - ${data.tour_date_stop}'),
                const SizedBox(height: 16),
                InfoTile(
                    valueKey: 'Кол-во ночей', value: '${data.horating} ночей'),
                const SizedBox(height: 16),
