...
import 'package:test_zadanie/features/reservation_details/presentation/pages/third_screen.dart/widgets/info_tile.dart';
import 'package:test_zadanie/features/reservation_details/presentation/pages/third_screen.dart/widgets/person_info_tile.dart';
    ...
    return BlocBuilder<DetailsBloc, DetailsState>(
      builder: (context, state) {
        if (state is DetailsLoadingState) {
          ...
          final BookingData data = state.data;
          const String totalPrice = '';
